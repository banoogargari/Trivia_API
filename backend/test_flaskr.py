...
class TriviaTestCase(unittest.TestCase):
    ...
    def test_get_paginated_questions(self):
        ...
        self.assertTrue(len(data['selection']))
    ...
    def test_create_question(slef):
        res = slef.client().post('/questions', json=slef.new_question)
        data = json.loads(res.data)
    ...
    def test_search_term(self):
        ...
        self.assertIsNotNone(len(data['searchResults']))
    ...
    def test_play_quizes(self):
        quiz_play = {'previous_questions': [],'quiz_category': {'id': 6, 'type': 'sport'}}

        res = self.client().post('/quizzes', json=quiz_play)
        data = json.loads(res.data)
